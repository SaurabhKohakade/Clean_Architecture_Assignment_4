                ...
                child: Column(
                  children: [
                    ...
                    CustomRoundedTextField(
                        ...
                        error_msg: 'email must contain @ and "."'),
                    const SizedBox(
                      height: 30,
                    ),
                    CustomRoundedTextField(
                      ...
                      error_msg: 'Password must contain 6 character, 1 special character',
                    ),
                    const SizedBox(
                      height: 30,
                    ),
                    CustomRoundedTextField(
                      ...
                      error_msg: 'Password must contain 6 letters, 1 special character',
                    ),
                    const SizedBox(
                      height: 60,
                    ),
                      ...
                      callback: () {
                        if(emailController.text.toString().trim().isEmpty || 
                         passwordController.text.toString().trim().isEmpty ||
                           confirmPasswordController.text.toString().trim().isEmpty
                           )
                        {
                          
                          return null;
                        }else if ( (passwordController.text.toString().trim() != confirmPasswordController.text.toString().trim())){
                          return null;
                          }
                          else{
